 ...
 * generated in the br.hikarikun92.springbootsoapdemo.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHello_QNAME = new QName("http://learnwebservices.com/services/hello", "SayHello");
    private final static QName _SayHelloResponse_QNAME = new QName("http://learnwebservices.com/services/hello", "SayHelloResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.hikarikun92.springbootsoapdemo.soap
     * 
     */
